...
* **USF (Nintendo 64 — `.usf`/`.miniusf`):** Playback via **lazyusf2** by **Christopher Snowhill (kode54)**, built on **Mupen64Plus-rsp-hle** and Mupen64 v0.5. Licensed under **GPL-2.0** — still linked into both variants.
