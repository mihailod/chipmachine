...
* **TFMX (`tfmxplay`):** `tfmxplay` 1.1.7 by **Jonathan H. Pickard** (maintained by Neochrome). Licensed under **GPL-2.0**. Vendored but **not compiled** — actual TFMX playback goes through UADE.
