...
// chipmachine port: macOS branch was missing entirely.
#	include <stdint.h>
#endif

// chipmachine port: upstream typedef'd uint32/int32 as (unsigned) long, which is
// 64-bit under LP64 (macOS/Linux) and silently corrupts every APU register
// struct layout and bitmask. Pin them to fixed-width stdint types.
#ifndef WINDOWS
#	include <stdint.h>
#endif
