...
public:
	...
	static ProbeResult ProbeFileHeaderOMF(MemoryFileReader file, const uint64 *pfilesize);  // [chipmachine] Onyx Music File
	...
	bool ReadDSMv1(FileReader &file, ModLoadingFlags loadFlags = loadCompleteModule);  // [chipmachine] DSIK old/v1 ("DSM"+0x10)
	bool ReadDSm(FileReader &file, ModLoadingFlags loadFlags = loadCompleteModule);
	...
	bool ReadOMF(FileReader &file, ModLoadingFlags loadFlags = loadCompleteModule);  // [chipmachine] Onyx Music File (.omf)
