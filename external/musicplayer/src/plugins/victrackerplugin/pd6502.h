/* -------------------------------------------------------------------------
   Vendored UNCHANGED from https://github.com/C-Chads/MyLittle6502 (fake6502.h),
   David MHS Webster (gek169) public-domain / CC0 continuation of Mike Chambers'
   Fake6502 v1.1. Only this note was added.

   Used by the mas build in place of the GPLv2 omarandlorraine fake6502 fork --
   see vt_cpu_pd.c, which is the only file that includes this one, and which
   prefixes the core's non-static symbols before including it.
   ------------------------------------------------------------------------- */
