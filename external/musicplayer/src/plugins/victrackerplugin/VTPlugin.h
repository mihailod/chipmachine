...
// interprets; we run that routine (vendored pre-assembled, BSD) on the
// MyLittle6502 core and route its VIC sound-register writes into our own VIC-I
// core. See vt_machine.cpp.
