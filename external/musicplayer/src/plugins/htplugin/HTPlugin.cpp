...
std::set<std::string> HTPlugin::getSupportedExtensions() const
{
    return supported_ext;
}

std::vector<std::string> HTPlugin::getSecondaryFiles(const std::string& name)
{
    // .minidsf/.minissf reference a shared .dsflib/.ssflib via PSF "_lib" tags;
