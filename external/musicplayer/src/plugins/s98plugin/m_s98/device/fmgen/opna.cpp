...
// ---------------------------------------------------------------------------
//	内蔵リズム音源 (OPNA rhythm sample ROM) を読みこむ
//	Built-in rhythm samples decoded from the OPNA rhythm sample ROM
//	(see opna_rhythm_rom.cpp, generated by gen_rhythm_rom.c). Used when no
//	external rhythm .WAV set is provided, so FMP/S98 drums work out of the box.
//
