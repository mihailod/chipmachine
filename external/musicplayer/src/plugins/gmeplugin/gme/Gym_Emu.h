...
private:
	// holds the inflated sequence when a GYMX file is zlib-packed; empty
	// otherwise (sequence is then referenced in place from the input buffer)
	blargg_vector<byte> packed_data;
