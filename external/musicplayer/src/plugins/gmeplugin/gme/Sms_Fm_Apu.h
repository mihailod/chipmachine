...
class Sms_Fm_Apu {
public:
	// Ym2413_Emu now wraps a real OPLL (emu2413), so SMS FM renders. Report
	// supported so Sgc_Core initializes FM instead of warning "FM sound not
	// supported" (which left YM2413 titles' FM subsongs silent).
