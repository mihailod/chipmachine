...
#include "players/FXMPlay.h"
#include "players/AMADPlay.h"
...
{ TXT(".fxm"), FXM_Init, FXM_Play, FXM_Cleanup, FXM_GetInfo, FXM_Detect, false },
{ TXT(".amad"), AMAD_Init, FXM_Play, FXM_Cleanup, AMAD_GetInfo, AMAD_Detect, false } };
