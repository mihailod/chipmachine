#pragma once
// Phaser1 beeper engine Z80 player source, extracted verbatim from
// 1tracker's phaser1.1te (Original Z80 code and 1tracker version by Shiru,
// 2010-2015; released as public domain). Assembled in-repo by z80asm.
// Three parts: the common player, plus a Synth (P1S) or Digital (P1D) drum
// section appended before the music data. See phaser1_pack.cpp.
namespace musix::bbsong {

static const char* const PHASER1_COMMON_ASM = R"ASM(
	org #8000
...
static const char* const PHASER1_SYNTH_ASM = R"ASM(
...
static const char* const PHASER1_DIGITAL_ASM = R"ASM(
