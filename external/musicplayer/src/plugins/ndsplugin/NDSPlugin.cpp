...
std::set<std::string> NDSPlugin::getSupportedExtensions() const
{
    return supported_ext;
}

std::vector<std::string> NDSPlugin::getSecondaryFiles(const std::string& name)
{
    // .mini2sf references a shared .2sflib via PSF "_lib" tags; fetch it
