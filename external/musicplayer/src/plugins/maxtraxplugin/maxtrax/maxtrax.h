...
// NOTE: upstream ScummVM gates this header on ENABLE_KYRA/DYNAMIC_MODULES;
// here it is vendored as a standalone player, so a plain include guard is used.
#ifndef AUDIO_MODS_MAXTRAX_H
...
public:
	...
	// Number of scores (subsongs) parsed from the loaded module.
	int getScoreCount() const { return _numScores; }
