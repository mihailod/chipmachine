...
-- 132: Project AY refreshed against the LIVE site. bulba.untergrund.net turns out to
--     self-identify as "an archived version of the site as of 12/15/2024"; the current
--     one is ay.strangled.net, and three archives had moved on. For us the one that
--     matters is bulba_ay.7z v1.0 -> v1.3 (78,810 -> 551,721 bytes, 30 -> 304 .ay):
--     since 2026 Bulba has been ripping "the music that was missing from the known
--     collections" and adding authors/titles to existing files. ifist_ay.zip and
--     SoLOCPC.7z are byte-identical to what we already had.
--     data/projectay.txt regenerated by build_projectay.py: 613 -> 887 rows (612 kept,
--     275 added, 1 dropped -- "bulba/Ripped by Bulba/Loader.ay", genuinely gone
--     upstream) plus 9 metadata improvements on re-ripped files, all real composers
--     replacing "Unknown"/publisher names (Badlands -> Matt Furniss, Pang ->
--     Pierre-Eric Loriaux, 1943TM -> "1943: The Battle Of Midway" / Jason C. Brooke...).
--     New sub-dir "bulba/Moved from Tr_Songs/". The ZIP at
...
},
{
 ...
 },
 {
	...
	-- cannot read), so the .ay were repacked into one ZIP that PRESERVES the
	-- paths; IA serves its members individually. NB a MISSING member answers 503,
	-- not 404. Refreshed to 887 tunes in VERSION 132 against ay.strangled.net --
	-- the LIVE site; bulba.untergrund.net is a frozen 2024 snapshot, do not use it.
	name = "Project AY",
	id =  "projectay",
