...
--[[
    ...
    Settings.scroll = {                                                                                              
      ...
      "data/fontsmainscroll",  -- 4. font FOLDER: every .otf inside is loaded (alphabetical) into a rotating pool; drop in new fonts and they're picked up on next launch
